...
const diamond_env_1 = require("./diamond_env");
...
class DataClient extends Base {
     ...
     * @param options
     */
    getDiamondEnv(options) {
        return new diamond_env_1.DiamondEnv(options);
    }
    getServerListManager(options) {
        return new server_list_mgr_1.ServerListManager(options);
    }
    getSnapshot(options) {
        return new snapshot_1.Snapshot(options);
    }
}
