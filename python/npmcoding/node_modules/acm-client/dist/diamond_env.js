...
class DiamondEnv extends Base {
     ...
     * @constructor
     */
    constructor(options = { unit: const_1.CURRENT_UNIT }) {
    ...
    async syncConfigs(list) {
        ...
        for (let i = 0, len = results.length; i < len; i++) {
            ...
            const md5 = utils_1.getMD5String(content);
    ...
    async request(path, options = {}) {
        ...
        if (encode) {
            requestData = utils_1.encodingParams(data);
        }
        try {
    ...
    async batchGetConfig(dataIds, group) {
        const dataIdStr = dataIds.join(const_1.WORD_SEPARATOR);
...
exports.DiamondEnv = DiamondEnv;
//# sourceMappingURL=diamond_env.js.map